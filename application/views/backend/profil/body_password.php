                    ...
                    <div class="card card-outline">
                        <div class="card-body">
                            ...
                            <div class="form-group" style="text-align:center">
                                <button type="submit" class="btn btn-primary" id="btn_simpan_password" style="margin-right:5px"><i class="bx bx-fw bx-save"></i> Simpan</button>
                            </div>
                        </div>
                    </div>
                </div>
     ...
     $('#btn_simpan_password').on("click",function(){
        $('#form_password').validate({
            ...
            submitHandler: function() {
                $.ajax({
                    url : '<?php echo base_url('profil/reset_password'); ?>',
                    method: 'POST',
