                    ...
                    <div class="card card-outline">
                        <div class="card-body">
                            ...
                            <div class="form-group" style="text-align:center">
                                <button type="submit" class="btn btn-primary" id="btn_simpan_karyawan" style="margin-right:5px"><i class="bx bx-fw bx-save"></i> Simpan</button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            $('#form_karyawan').validate({
                ...
                submitHandler: function() {
                    $("#form_karyawan").load('submit', function(e){
                        $.ajax({
                            url : '<?php echo base_url('profil/edit_karyawan'); ?>',
                            method: 'POST',
