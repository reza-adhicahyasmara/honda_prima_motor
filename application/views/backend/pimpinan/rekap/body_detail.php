            ...
            <div class="row">
                ...
                <div class="col-sm-6 float-sm-right">
                    <ol class="breadcrumb float-sm-right m-2">
                        ...
                        <span class="breadcrumb-item"><a href="<?php echo base_url('pimpinan/rekap'); ?>">Rekap</a></span>
                            ...
                            <tbody>
                                <?php
                                    for ($i = 0; $i < count($data_nilai); $i++) {
                                        ...
                                        echo "<td style='text-align: center; vertical-align: middle;'><a class='btn btn-info' href='".base_url('pimpinan/karyawan/data_penialaian_sales/') . $data_nilai[$i]["nik_karyawan"] . "'><span class='bx bx-fw bx-line-chart'></span></a></td>";
                                        echo "</tr>";
                                    }
                                ?>
                            </tbody>
