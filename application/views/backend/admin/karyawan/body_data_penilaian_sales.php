...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h1 class="m-1 text-dark"><span class="nav-icon bx bx-fw bx-line-chart"></span>Data Penilaian Sales</h1>
                </div>
                <div class="col-sm-6 float-sm-right">
                    <ol class="breadcrumb float-sm-right m-2">
                        <span class="breadcrumb-item"><a href="<?php echo base_url('admin/dashboard'); ?>">Dashboard</a></span>
                        <span class="breadcrumb-item"><a href="<?php echo base_url('admin/karyawan'); ?>">Karyawan</a></span>
                        <span class="breadcrumb-item active">Data Penilaian Sales</span>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="row">
                        <div class="col-12 col-sm-12">
                            <div class="form-group float-right">
                                <a href="<?php echo base_url('admin/karyawan/print/').$data_karyawan['nik_karyawan'];?>" target="_blank" class="btn btn-warning" id="btn_print"><span class="bx bx-fw bx-printer"></span> Print</a>
                            </div>
                        </div>
